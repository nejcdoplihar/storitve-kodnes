...
// ============================================================
// POTEK BADGE — POTEKLO / KMALU POTEČE / VELJAVNO
// ============================================================
...
function PodaljsajButton({
  ...
  if (status === "error")
    return (
      <span style={{ fontSize: 12, color: "#dc2626", padding: "6px 14px" }}>Napaka</span>
    );
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 8,
        border: "none",
        background: status === "loading" ? "#99d6d8" : BRAND,
        color: "#fff",
        fontSize: 13,
        fontWeight: 600,
...
// ============================================================
// STRANKE TA MESEC — TABELA
// ============================================================
function StrankeTekoMesec({
  stranke: initialStranke,
  loading,
}: {
  stranke: Stranka[];
  loading: boolean;
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 13, color: "#9ca3af", marginTop: 3 }}>
            Stranke katerim poteče storitev ta mesec
          </div>
        </div>
        {thisMonth.length > 0 && (
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {thisMonth.map((stranka, i) => {
                  ...
                  const billingLabel = Array.isArray(billing)
                    ? billing[0]
                    : billing || "";
                  ...
                  return (
                    <tr
                      ...
                      style={{
                        borderBottom:
                          i < thisMonth.length - 1 ? "1px solid #f7f7f7" : "none",
                      }}
                      onMouseEnter={(e) =>
                    ...
                    >
                      ...
                      <td style={{ padding: "14px 16px" }}>
                        <div
                          ...
                          dangerouslySetInnerHTML={{ __html: stranka.title.rendered }}
                        />
                        {stranka.acf?.domena_url && (
                          <a
                            href={
                              stranka.acf.domena_url.startsWith("http")
                                ? stranka.acf.domena_url
                                : `https://${stranka.acf.domena_url}`
                            }
                            target="_blank"
                            rel="noreferrer"
                            style={{
                      ...
                      <td style={{ padding: "14px 16px", whiteSpace: "nowrap" }}>
                        ...
                        >
                          {daysLeft < 0
                            ? `${Math.abs(daysLeft)} ${Math.abs(daysLeft) === 1 ? "dan" : Math.abs(daysLeft) < 5 ? "dni" : "dni"} nazaj`
                            : daysLeft === 0
                            ? "danes"
                            : `čez ${daysLeft} ${daysLeft === 1 ? "dan" : daysLeft < 5 ? "dni" : "dni"}`}
                        </div>
                      </td>
                      ...
                      <td style={{ padding: "14px 16px 14px 8px", paddingRight: 24 }}>
                        ...
                        >
                          <PodaljsajButton
                            ...
                            onSuccess={(newDate) =>
                              handleDateUpdate(stranka.id, newDate)
                            }
                          />
                          <a
      ...
      >
        <div style={{ padding: "18px 24px", borderBottom: "1px solid #f5f5f5" }}>
          ...
          <div style={{ fontSize: 13, color: "#aaa", marginTop: 2 }}>
            Dnevnik sprememb, dodajanj in brisanj
          </div>
        </div>
        {activityLoading ? (
            ...
            <tbody>
              {activityLog.map((item, i) => {
                ...
                return (
                  <tr
                    key={item.id}
                    style={{ borderBottom: i < activityLog.length - 1 ? "1px solid #f7f7f7" : "none" }}
                    onMouseEnter={(e) => (e.currentTarget.style.background = "#fafafa")}
                    onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}
                  >
                    <td style={{ padding: "12px 24px", fontWeight: 600, fontSize: 14, color: "#111", maxWidth: 220, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {item.title}
                    </td>
                    ...
                    <td style={{ padding: "12px 24px", fontSize: 13, color: "#555", fontWeight: 500 }}>
                      {item.user}
                    </td>
