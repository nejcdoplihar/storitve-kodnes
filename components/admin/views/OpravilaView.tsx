        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <div>
              ...
              <select
                value={form.uporabnik}
                onChange={(e) => set("uporabnik", e.target.value)}
                style={inputStyle}
              >
          ...
          <div>
            <label style={labelStyle}>
              Naslov opravila <span style={{ color: "#ef4444" }}>*</span>
            </label>
            <input
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              ...
              <select
                value={form.cas_ure}
                onChange={(e) => set("cas_ure", e.target.value)}
                style={inputStyle}
              >
                {CAS_OPTIONS.map((v) => (
...
export function OpravilaTabela({
  ...
  const toggleAll = () => {
    if (selected.size === opravila.length) {
      setSelected(new Set());
    } else {
      setSelected(new Set(opravila.map((o) => o.id)));
    }
  };
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
        ...
        >
          <div style={{ fontSize: 12, color: "#888", marginBottom: 4 }}>Skupaj opravil</div>
          <div style={{ fontSize: 22, fontWeight: 700, color: "#111" }}>{opravila.length}</div>
        </div>
        <div
          style={{
            background: "#fff",
        ...
        >
          <div style={{ fontSize: 12, color: "#888", marginBottom: 4 }}>Skupaj vrednost</div>
        ...
        >
          <div style={{ fontSize: 12, color: "#dc2626", marginBottom: 4 }}>Neplačano</div>
          <div style={{ fontSize: 22, fontWeight: 700, color: "#dc2626" }}>
            {neplačanoZnesek.toLocaleString("sl-SI", { minimumFractionDigits: 2 })} €
          </div>
        </div>
      </div>
                    ...
                    >
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <div style={{ fontWeight: 600, fontSize: 14, color: "#111" }}>
                          {o.acf?.naslov_opravila || o.title.rendered}
                        </div>
                        {o.acf?.opis_opravila && (
                          <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>
                            {o.acf.opis_opravila.slice(0, 80)}
                            {o.acf.opis_opravila.length > 80 ? "..." : ""}
                          </div>
                        )}
                      </td>
                      ...
                      <td style={{ padding: "12px 16px", fontSize: 13, color: "#333", whiteSpace: "nowrap" }}>
                        {o.acf?.cas_ure} ur
                        {o.acf?.custom_postavka && (
                          <div style={{ fontSize: 11, color: "#aaa" }}>{postavka} €/h</div>
                        )}
                      </td>
